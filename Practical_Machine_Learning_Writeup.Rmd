...
setwd("/rsrch1/biostatistics/ayjoon/_Education/2016.07.18.Pratical.Machine.Learning");
##set pandoc as the default format##
options("citation_format"="pandoc");
```

```{r echo=FALSE, message=FALSE}
if (!require("pacman")) install.packages("pacman", dependencies=TRUE, repos='http://cran.rstudio.com/');
pacman::p_load(caret, corrplot);
```
